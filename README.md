...
- 二分图的最大权匹配(KM算法).(poj1459,poj3436)

#### 三、数据结构

- 字符串.(poj1035,poj3080,poj1936)
...
---------- | -------------
3299       | 数学题，简单变量代换	
1083       | 区间加+求单点最值，O(n+200)扫一遍即可
3006       | 暴力枚举，可加筛法	
2255       | 按左右根dfs一下	3094	模拟
2159       | 判断同构，按频率排序	
2739       | 两个指针走，可加筛法
2262       | 暴力枚举，可加筛法
1503       | 高精度加法
...
- 较为复杂的动态规划(如动态规划解特别的施行商问题等). (poj1191,poj1054,poj3280,poj2029,poj2948,poj1925,poj3034)
...
- 数学.
  ...
  3.最大公因数,扩展的欧几里德(中国剩余定理).(poj3101)
- 计算方法.
  1.0/1分数规划.(poj2976)
  2.三分法求解单峰(单谷)的极值.
...
2253       | 本质为最小生成树
3126       | 深搜
1276       | 限个数不带权完全背包，dp存个数
2533       | 最长上升子序列
3252       | 组合数，数位dp
1019       | 答案不超过31268，枚举
2635       | 大数对小数取模
1845       | 质因数分解+快速幂
2115       | 扩展欧几里得，解二元一次不定方程
3273       | 二分答案，贪心选择
3258       | 二分答案，判定是否有解
1905       | 二分，答案单调
